...
mybinarytree[3]="red"
mybinarytree[4]="blue"
mybinarytree[6]="yellow"
mybinarytree[2]="at"

print(mybinarytree[6])
print(mybinarytree[2])
import random
import matplotlib.pyplot as plt
for r in range(100):
    num = random.randint(0,1000)
    my_min = mybinarytree.get_min()
    my_max = mybinarytree.get_max()
...
if __name__ == '__main__':
    ...
    values_tree, values_tree_min, values_tree_max = [], [], []
